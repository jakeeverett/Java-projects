...
/**
 * The next method displays the contents of the square by calling several methods.
 */
    void displaySquare(){
    	for(int i =0;i<n_size+1;i++) {
...
/**
 * The next method prints the interior contesnts of the squrae.
 * It also calls the ordinalIndexOf method.
 * This method was created to shorten the display squares method so that It would fit on one page.
 */
    void printInterior(int i, int j, int test){
